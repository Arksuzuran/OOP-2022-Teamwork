...
public class IconController {
    ...
    public static Image n6 = new Image(Objects.requireNonNull(IconController.class.getResource("icons/6.png")).toString());
    ...
    public static Image i6 = new Image(Objects.requireNonNull(IconController.class.getResource("icons/66.png")).toString());
